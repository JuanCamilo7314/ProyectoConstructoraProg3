...
export class PaisCiudadController {
  ...
  async create(
    @param.path.number('id') id: typeof Pais.prototype.CodigoP,
    @requestBody({
      content: {
        'application/json': {
