...
export class ProyectoRepository extends DefaultCrudRepository<
  Proyecto,
  typeof Proyecto.prototype.CodigoProy,
  ProyectoRelations
> {

  public readonly ciudad: BelongsToAccessor<Ciudad, typeof Proyecto.prototype.CodigoProy>;

  public readonly bloques: HasManyRepositoryFactory<Bloque, typeof Proyecto.prototype.CodigoProy>;
