...
export class BloqueRepository extends DefaultCrudRepository<
  Bloque,
  typeof Bloque.prototype.CodigoB,
  BloqueRelations
> {

  public readonly proyecto: BelongsToAccessor<Proyecto, typeof Bloque.prototype.CodigoB>;

  public readonly inmuebles: HasManyRepositoryFactory<Inmueble, typeof Bloque.prototype.CodigoB>;
